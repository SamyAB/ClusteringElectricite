...
#On ne voit pas de rééle frontière sur la distance plot, la encore un k-means sur le SOM
#On essaye d'utiliser k=3
KM_SOM = kmeans(SOM_1010$codes,3)
plot(x= 1:168, y= as.matrix(KM_SOM$centers)[1,],type = 'l',col = 1)
lines(x=1:168, y =as.matrix(KM_SOM$centers)[2,],type = 'l',col = 2)
lines(x=1:168, y =as.matrix(KM_SOM$centers)[3,],type = 'l',col = 3)
...
#Dessin des courbes pour les deux centres
plot(x = 1:120, y = centers_CAH_2_JO[2,] ,type = 'l' , col = 2)
lines(x = 1:120, y = centers_CAH_2_JO[1,] ,type = 'l' , col = 1)

#Pour 3 clusters
classes_CAH3_JO <- cutree(h_ward, k=2)

##Création d'une matrice de centres de classes 
centers_CAH_3_JO = matrix(data = 0, nrow = 3 , ncol = 120) #Matrice contenant les deux centres des deux clusters
...
plot(x = 1:120, y = centers_CAH_3_JO[2,] ,type = 'l' , col = 2)
lines(x = 1:120, y = centers_CAH_3_JO[1,] ,type = 'l' , col = 1)
lines(x = 1:120, y = centers_CAH_3_JO[3,] ,type = 'l' , col = 3)
...
plot(x = 1:120, y=as.matrix(KM_2_JO$centers)[1,],type = 'l',col = 1)
lines(x=1:120, y =as.matrix(KM_2_JO$centers)[2,],type = 'l',col = 2)
KM_2_JO$tot.withinss
# K = 3 
KM_3_JO = kmeans(electricite_JO,3)
plot(x = 1:120, y=as.matrix(KM_3_JO$centers)[2,],type = 'l',col = 2)
lines(x=1:120, y =as.matrix(KM_3_JO$centers)[1,],type = 'l',col = 1)
lines(x=1:120, y =as.matrix(KM_3_JO$centers)[3,],type = 'l',col = 3)
KM_3_JO$tot.withinss
# K = 4
KM_4_JO = kmeans(electricite_JO,4)
plot(x = 1:120, y=as.matrix(KM_4_JO$centers)[3,],type = 'l',col = 3)
lines(x=1:120, y =as.matrix(KM_4_JO$centers)[1,],type = 'l',col = 1)
lines(x=1:120, y =as.matrix(KM_4_JO$centers)[4,],type = 'l',col = 4)
lines(x=1:120, y =as.matrix(KM_4_JO$centers)[2,],type = 'l',col = 2)
KM_4_JO$tot.withinss
# K = 5
KM_5_JO = kmeans(electricite_JO,5)
plot(x = 1:120, y=as.matrix(KM_5_JO$centers)[3,],type = 'l',col = 3)
lines(x=1:120, y =as.matrix(KM_5_JO$centers)[1,],type = 'l',col = 1)
lines(x=1:120, y =as.matrix(KM_5_JO$centers)[4,],type = 'l',col = 4)
lines(x=1:120, y =as.matrix(KM_5_JO$centers)[2,],type = 'l',col = 2)
lines(x=1:120, y =as.matrix(KM_5_JO$centers)[5,],type = 'l',col = 5)
...
#On ne voit pas de rééle frontière sur la distance plot, la encore un k-means sur le SOM
#On essaye d'utiliser k=3
KM_SOM_JO = kmeans(SOM_1010_JO$codes,3)
plot(x= 1:120, y= as.matrix(KM_SOM_JO$centers)[1,],type = 'l',col = 1)
lines(x=1:120, y =as.matrix(KM_SOM_JO$centers)[2,],type = 'l',col = 2)
lines(x=1:120, y =as.matrix(KM_SOM_JO$centers)[3,],type = 'l',col = 3)
